...
static const int DNS_CLAW_BANNER_COLORS[][3] = {
    {255, 20, 20},   {255, 60, 50},   {255, 100, 80},  {255, 140, 110}, {255, 170, 150},
    {255, 195, 180}, {255, 215, 210}, {255, 230, 225}, {255, 245, 242}, {255, 255, 255},
};
...
static inline void print_banner_to(FILE *fp)
{
    ...
    for (int i = 0; i < DNS_CLAW_BANNER_LINES; i++) {
        fprintf(fp, "\033[38;2;%d;%d;%dm%s" CLR_RESET "\n", DNS_CLAW_BANNER_COLORS[i][0],
                DNS_CLAW_BANNER_COLORS[i][1], DNS_CLAW_BANNER_COLORS[i][2], DNS_CLAW_BANNER_ART[i]);
    }
    fprintf(fp, "\n");
}
